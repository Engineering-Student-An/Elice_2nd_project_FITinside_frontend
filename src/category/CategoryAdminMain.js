                    ...
                    <nav aria-label="Page navigation example">
                        <ul className="pagination justify-content-center">
                            ...
                            <li className={`page-item ${parentPage === 1 ? 'disabled' : ''}`}>
                                <button
                                    className="page-link"
                                    onClick={() => setParentPage(Math.max(parentPage - 1, 1))}
                                    aria-label="Previous">
                            ...
                            <li className={`page-item ${parentPage === totalParentPages ? 'disabled' : ''}`}>
                                <button
                                    className="page-link"
                                    onClick={() => setParentPage(Math.min(parentPage + 1, totalParentPages))}
                                    aria-label="Next">
                                    <span aria-hidden="true">&#8250;</span>
                                </button>
                            </li>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul className="pagination justify-content-center">
                                    ...
                                    <li className={`page-item ${childPage === 1 ? 'disabled' : ''}`}>
                                        <button
                                            className="page-link"
                                            onClick={() => setChildPage(Math.max(childPage - 1, 1))}
                                            aria-label="Previous">
                                            <span aria-hidden="true">&#8249;</span>
                                        </button>
                                    </li>
                                    ...
                                    <li className={`page-item ${childPage === totalChildPages ? 'disabled' : ''}`}>
                                        <button
                                            className="page-link"
                                            onClick={() => setChildPage(Math.min(childPage + 1, totalChildPages))}
                                            aria-label="Next">
                                            <span aria-hidden="true">&#8250;</span>
                                        </button>
                                    </li>
                                    ...
                                    <li className={`page-item ${childPage === totalChildPages ? 'disabled' : ''}`}>
                                        <button
                                            className="page-link"
                                            onClick={() => setChildPage(totalChildPages)}
                                            aria-label="Last">
                                            <span aria-hidden="true">&raquo;</span>
                                        </button>
                                    </li>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul className="pagination justify-content-center">
                            ...
                            <li className={`page-item ${parentPage === totalOption2Pages ? 'disabled' : ''}`}>
                                <button
                                    className="page-link"
                                    onClick={() => setParentPage(Math.min(parentPage + 1, totalOption2Pages))}
                                    aria-label="Next">
                                    <span aria-hidden="true">&#8250;</span>
                                </button>
                            </li>
                            ...
                            <li className={`page-item ${parentPage === totalOption2Pages ? 'disabled' : ''}`}>
                                <button
                                    className="page-link"
                                    onClick={() => setParentPage(totalOption2Pages)}
                                    aria-label="Last">
                                    <span aria-hidden="true">&raquo;</span>
                                </button>
                            </li>
