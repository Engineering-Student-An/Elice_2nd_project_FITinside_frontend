...
const CategoryUpdate = () => {
    ...
    useEffect(() => {
        ...
        // 선택된 카테고리 정보 가져오기
        axios.get(`https://obpedvusnf.execute-api.ap-northeast-2.amazonaws.com/api/categories/${id}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        })
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://obpedvusnf.execute-api.ap-northeast-2.amazonaws.com/api/admin/categories/${id}`, formData, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
