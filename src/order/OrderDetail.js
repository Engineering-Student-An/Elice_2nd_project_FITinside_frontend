...
const OrderDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrderDetail = async () => {
            try {
                ...
                const response = await axios.get(`/fr/api/orders/${orderId}`, {
                    headers: {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await axios.patch(`/fr/api/orders/${orderId}`, updatedData, {
                headers: {
    ...
    const handleCancelClick = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`/fr/api/orders/${orderId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
