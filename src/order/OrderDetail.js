...
const OrderDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrderDetail = async () => {
            try {
                ...
                const response = await axios.get(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/orders/${orderId}`, {
                    headers: {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await axios.patch(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/orders/${orderId}`, updatedData, {
                headers: {
    ...
    const handleCancelClick = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/orders/${orderId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
