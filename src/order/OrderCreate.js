...
const OrderCreate = () => {
    ...
    useEffect(() => {
        ...
        const fetchProductDetails = async () => {
            ...
            for (const item of storedOrderData) {
                try {
                    const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/products/${item.productId}`, {
                        headers: {
        ...
        const fetchDefaultAddress = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/addresses/default`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
                });
    ...
    const addAddress = async (deliveryData) => {
        try {
            ...
            const addressResponse = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/addresses`, deliveryData, {
                headers: {
    ...
    const updateAddress = async (deliveryData) => {
        try {
            const token = localStorage.getItem('token');
            const response = await axios.patch(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/addresses/${selectedAddressId}`, deliveryData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const createOrder = async (deliveryData) => {
        try {
            const token = localStorage.getItem('token');
            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/order`, {
