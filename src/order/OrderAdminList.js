...
const OrderAdminList = () => {
    ...
    const fetchAdminOrders = async (filter = false) => {
        try {
            ...
            const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/orders`, {
                headers: {
    ...
    const handleSaveStatusChange = async (orderId) => {
        ...
        try {
            ...
            const response = await axios.patch(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/orders/${orderId}/status`, requestData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleDeleteOrder = async (orderId) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/orders/${orderId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
