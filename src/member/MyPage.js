...
const MyPage = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                const response = await axios.get('http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/user/me', {
                    headers: {
    ...
    const handleSaveName = async () => {
        try {
            ...
            await axios.put(
                'http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/user/username', // 이름 수정 API 엔드포인트
                { userName: newName },
    ...
    const handleSavePhone = async () => {
        try {
            ...
            const token = localStorage.getItem('token');
            await axios.put(
                'http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/user/phone', // 전화번호 수정 API 엔드포인트
                {
    ...
    const handleDeleteAccount = async () => {
        try {
            const token = localStorage.getItem('token');
            await axios.delete('http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/user/delete', {
                headers: { Authorization: `Bearer ${token}` }
            });
