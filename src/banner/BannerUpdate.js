...
const BannerUpdate = () => {
    ...
    // 배너 정보 가져오기
    useEffect(() => {
        axios.get(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/banners/${id}`, {
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            axios.put(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/admin/banners/${id}`, formData, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
