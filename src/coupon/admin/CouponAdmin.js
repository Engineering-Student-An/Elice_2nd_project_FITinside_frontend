...
const CouponAdmin = () => {
    ...
    const fetchCoupons = async (page, includeInActiveCoupons) => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/coupons`, {
                params: {
                    page: page,
            ...
            try {
                ...
                // 토큰 갱신 후 다시 요청
                const newResponse = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/coupons`, {
                    params: {
                        page: page,
                        includeInActiveCoupons: includeInActiveCoupons
                    },
    ...
    const fetchCategories = async () => {
        try {
            ...
            try {
                ...
                // 토큰 갱신 후 다시 요청
                const newResponse = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/categories`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}` // 갱신된 토큰 사용
                    },
                });
    ...
    const deactivateCoupon = async (id) => {
        try {
            const response = await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/coupons/${id}`, {
                headers: {
