...
const CouponSearchModal = ({ isOpen, onRequestClose }) => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const response = await axios.get(`https://zaswdsrcjxykrnsf.tunnel-pt.elice.io/api/coupons/code/${couponCode}`, {
                headers: {
    ...
    const handleCouponSubmit = async () => {
        ...
        try {
            const response = await axios.post('https://zaswdsrcjxykrnsf.tunnel-pt.elice.io/api/coupons', couponCode, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
