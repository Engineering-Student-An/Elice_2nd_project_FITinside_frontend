...
const CouponSearchModal = ({ isOpen, onRequestClose }) => {
    ...
    const handleSearch = async () => {
        ...
        try {
            const response = await axios.get(`http://ec2-3-34-78-114.ap-northeast-2.compute.amazonaws.com:8080/api/coupons/code/${couponCode}`, {
                headers: {
    ...
    const handleCouponSubmit = async () => {
        ...
        try {
            const response = await axios.post('http://ec2-3-34-78-114.ap-northeast-2.compute.amazonaws.com:8080/api/coupons', couponCode, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
