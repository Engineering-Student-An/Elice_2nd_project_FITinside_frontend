...
const ProductUpdate = () => {
    ...
    const deleteProductImages = async () => {
        try {
            ...
            if (imageUrlsToDelete.length > 0) {
                await axios.delete(
                    `http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/admin/products/${id}/images`,
                    {
            ...
            if (descImageUrlsToDelete.length > 0) {
                await axios.delete(
                    `http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/admin/products/${id}/description-images`,
                    {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 상품 업데이트 요청
            await axios.put(`http://ec2-3-34-36-20.ap-northeast-2.compute.amazonaws.com:8081/api/admin/products/${id}`, formData, {
                headers: {
