...
const ProductUpdate = () => {
    ...
    const deleteProductImages = async () => {
        try {
            ...
            if (imageUrlsToDelete.length > 0) {
                await axios.delete(
                    `${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/products/${id}/images`,
                    {
            ...
            if (descImageUrlsToDelete.length > 0) {
                await axios.delete(
                    `${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/products/${id}/description-images`,
                    {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 상품 업데이트 요청
            await axios.put(`${process.env.NEXT_PUBLIC_BACKEND_PROXY}/api/admin/products/${id}`, formData, {
                headers: {
